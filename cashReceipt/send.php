...
if(isset($_POST['sendEmail']) || isset($_POST['send']))
{
    ...
    ****************************************************************************/
    ...
    $invoice->setFooternote("http://www.TheCreatix.com");
            ...
            <div class="row">
                ...
                <div class="col-sm-6 emailForm-panel">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="TheCreatix.com" name="name" id="name" onkeyup="changePreValue()" autocomplete="off">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="preview-panel">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-static">You've received an invoice from <span id="prevName">TheCreatix.com</span></p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview-msg-pnl">
                                ...
                                <div class="preview-msg">
                                    ...
                                    <h2><span id="emailHeading">TheCreatix.com</span></h2>

                                    <p>Greetings</p>

                                    <p>You've received an invoice from <span id="emailSub">TheCreatix.com</span></p>

                                    <p>You will find a PDF attached.</p>

                                    <p id="prevMesg"></p>

                                    <p><small><strong>Invoicer</strong> - Invoices generator app by <a href="http://www.thecreatix.com" target="_blank">TheCreatix.com</a></small></p>
