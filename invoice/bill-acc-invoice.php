...
<html>
	<head>
    <title>Accessories Invoice</title>
        <style type="text/css">
        body {      
            font-family: Verdana;
        }
    ...
    <div class="invoice">
        ...
        <div class="invoice-details">
            Invoice No: <?php echo str_pad($select['billing_id'], 3, "0", STR_PAD_LEFT)."-02";?>
            <br />
        ...
        <div class="clear-fix"></div>
            ...
            $articles = array($productDetail,1,$product_price['side_stand']+$product_price['foot_rest']+$product_price['leg_guard']+$product_price['chrome_set']);
